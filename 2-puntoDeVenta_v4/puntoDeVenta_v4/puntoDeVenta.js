calcularValorTotal = function () {
  ...
  let precioProducto;
  precioProducto = recuperarTexto("txtPrecio"); // SE UTILIZA PARA RECUPERAR EL PRECIO COMO FLOAT
  let cantidad;
  cantidad = recuperarTexto("txtCantidad"); // SE UTILIZA PARA RECUPERAR LA CANTIDAD COMO INT
  let porcentajeDescuento;
  porcentajeDescuento = recuperarTexto("txtPorcentajeDescuento");
